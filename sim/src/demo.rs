...
use ship::{Attach, Structure, beam, engine, fuel_tank, part, vessel};
...
pub fn simple_ship() -> Structure {
    ...
    let mods = vec!(
        (Attach { location: 6.0, rotation: 3.0 * PI / 2.0 }, box rev_l),
        ...
        (Attach { location: 0.0, rotation: 0.0}, box part(vessel(7.0, 7.0))),
